...
namespace Xamarin.Contacts
{
    public class Contact
    {
        ...
        internal List<GroupMembership> groupMemberships = new List<GroupMembership>();

        public IEnumerable<GroupMembership> GroupMemberships
        {
            get { return this.groupMemberships; }
            set { this.groupMemberships = new List<GroupMembership>(value); }
        }
